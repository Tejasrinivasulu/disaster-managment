...
export const OPS_WORKFLOW = [
  ...
  },
  {
    ...
    description: 'Demand vs availability, severity, priority, transport, accessibility',
    to: '/allocation',
    icon: GitBranch,
    roles: [ROLES.ADMIN, ROLES.COORDINATOR],
  ...
  },
  {
    ...
    description: 'Recalculate demand and reallocate if needed — then operations continue',
    to: '/demand',
    icon: RefreshCw,
    roles: [ROLES.ADMIN, ROLES.COORDINATOR],
    outputs: ['Updated demand', 'Reallocation'],
    loops: true,
  },
]
